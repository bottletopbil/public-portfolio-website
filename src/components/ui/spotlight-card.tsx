...
interface GlowCardProps {
  ...
  radius?: number; // pixels, used for both card and glow border
}
...
const GlowCard: React.FC<GlowCardProps> = ({ 
  ...
  const getInlineStyles = () => {
    ...
    // Also mirror the radius on the element itself for visual match
    (baseStyles as any).borderRadius = radius !== undefined ? `${radius}px` : undefined;
    return baseStyles;
  };
