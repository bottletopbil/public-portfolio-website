...
class AnimationController {
    ...
    constructor(ctx: CanvasRenderingContext2D, size: number, onComplete?: () => void, onCue?: () => void) {
        this.ctx = ctx
        this.size = size
    ...
    private setupTimeline() {
        ...
        this.timeline.to(this, {
            ...
            onComplete: () => {
                // Render final frame then fire completion callback
                this.render()
                if (this.onComplete) this.onComplete()
            },
        })
        // Cue next effect 3s before the end
        .add(() => {
            if (this.onCue) this.onCue()
        }, "-=3")
    }
...
export function SpiralAnimation({ onComplete, onCue }: { onComplete?: () => void; onCue?: () => void }) {
